...
tm_s2:			.byte	1			; Еденицы секунд

tm_m1:			.byte	1			; Десятки минут
tm_m2:			.byte	1			; Еденицы минут

tm_h1:			.byte	1			; Десятки часов
tm_h2:			.byte	1			; Еденицы часы

tm_d1:			.byte	1			; Десятки дня месяца 
tm_d2:			.byte	1			; Еденицы дня месяца

tm_mt1:			.byte	1			; Десятки месяца
tm_mt2:			.byte	1			; Еденицы месяца

tm_wd1:			.byte	1			; Десятки день недели 
tm_wd2:			.byte	1			; Еденицы день недели 

tm_y3:			.byte	1			; Десятки года
tm_y4:			.byte	1			; Еденицы года
...
tm_ah2:			.byte	1			; Еденицы часов будильника
tm_am1:			.byte	1			; Десятки минут будильника
tm_am2:			.byte	1			; Еденицы минут будильника
