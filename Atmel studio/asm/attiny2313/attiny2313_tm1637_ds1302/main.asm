...
.def	clock_mode		= r20		; Хранение состояния текущего отображения (время == 0, минуты и секунды == 1, дата == 2, год == 3)
...
start:	
	...
	rcall	DS1302_read_package_data	; инициализация DS1302 - первая команда в DS1302 после запуска МК игнорируется, без данной строки не сработает следующая команда
