...
.def	tm1637_dot		= r2		; отображеть двоеточие == 1, не отображать == 0
.def	blink_counter	= r3		; Счетчик, при длительном режиме mode !=0 сброс на режим mode_0
.def	dot_counter		= r4		; Счетчик для моргания двоеточием
