...
;========================================================
;	 Нажатии кнопки Clock mode \ Set
;========================================================

clock_mode_set_pressed:
		push	r17

		clock_mode_set_pressed_while:
			sbis	PIN_BUTTON_SET, BUTTON_SET
			rjmp	clock_mode_set_pressed_while

		lds		r17, mode
		cpi		r17, 0x00
		breq	clock_mode_pressed
	...
	set_pressed:
		...
		rjmp	clock_mode_set_pressed_end
	...
	clock_mode_pressed:
		...
		rjmp	clock_mode_set_pressed_1

		reset_clock_mode:
			ldi		r17, 0x00

		clock_mode_set_pressed_1:
			sts		clock_mode, r17
